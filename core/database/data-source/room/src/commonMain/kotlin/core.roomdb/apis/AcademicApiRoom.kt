...
interface AcademicApiRoom {
    ...
    suspend fun readFacultiesOrThrows():List<FacultyEntity>
     ...
     */
    suspend fun getDepartmentsByFacultyId(facultyId: String): Result<List<core.roomdb.entity.DepartmentEntity>>
     ...
     */
    suspend fun addDepartments(departments: List<core.roomdb.entity.DepartmentEntity>)
