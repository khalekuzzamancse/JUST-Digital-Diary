package com.just.cse.digital_diary.two_zero_two_three.root_home.destinations.local_destionations.about_us
...
@Composable
internal fun ColumnScope.FeaturesSection() {
    Text(
        text = "Features:",
...
@Composable
internal fun BulletPointText(symbol: String, feature: String, textColor: Color) {
...
@Composable
internal fun ColumnScope.ContactSection() {
    Text(
        text = "Contact:",
        style = MaterialTheme.typography.headlineMedium,
        modifier = Modifier.align(Alignment.CenterHorizontally)
...
@Composable
internal fun ColumnScope.ContactInfo() {
    FlowRow(
        modifier = Modifier.align(Alignment.CenterHorizontally),
...
@Composable
internal fun ContactIcon(imageVector: ImageVector, contentDescription: String) {
    Icon(
