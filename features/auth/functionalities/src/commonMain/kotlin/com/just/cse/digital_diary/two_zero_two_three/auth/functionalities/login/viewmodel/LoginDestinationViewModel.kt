package com.just.cse.digital_diary.two_zero_two_three.auth.functionalities.login.viewmodel
...
import com.just.cse.digital_diary.two_zero_two_three.auth.functionalities.login.states.LoginDestinationState
...
class LoginDestinationViewModel(
    ...
    suspend fun login(): LoginEvent.LoginDestinationEvent.LoginSuccess?{
        ...
        if (response is LoginResponseModel.Success) {
            onLoginSuccess()
            return LoginEvent.LoginDestinationEvent.LoginSuccess(
